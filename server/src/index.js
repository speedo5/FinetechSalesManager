...
// Middleware
app.use(cors({
  origin: process.env.CORS_ORIGIN || ['http://localhost:5173', 'http://localhost:8080', 'https://finetechsalesmanager-1.onrender.com','http://localhost:3000','https://finetechmedia.co.ke'],
  credentials: true
}));
